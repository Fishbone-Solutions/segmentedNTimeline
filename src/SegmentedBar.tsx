...
export class segmentedBar extends React.Component < any,
State > {
    ...
    render() {
        ...
        let flagTrackerListSeg6 = [];
        var categoryListDisplay = [...new Set(categoryList)];
        categoryListDisplay.sort((a, b) => a.localeCompare(b));
        for (const element of weeknoList) {
            weekDates.push(new Date(Date.parse(element)));
        }
        ...
        console.log("max date", result.max);
        ...
        const monthsArray = months.map((month, index) => (<div className="monthitem"
            style={
        ...
        for (const element of weeknoList) {
            const start = subMonths(result.min, 1);
            let week = new Date(Date.parse(element));
    ...
    function generateArray(start, end, count, variance) {
        ...
        const Segment1Categories = weeksSeg1.map((week, index) => (<>
            <Text text={
                    milestoneCategoryListSeg1[index] + String(activitySeg1[index]).substring(0, 30) + flagTrackerListSeg1[index]
                }
                x={
                    Seg1Values[index]["x"]
                }
                ...
                draggable={false}
                onClick={
                    e => this.setState({commentaryPlaceholder: commentarySeg1[index], activityPlaceholder: activitySeg1[index]})
                }/>
            <Line points={
                    [
                        Seg1Values[index]["x"],
        ...
        const Segment2Categories = weeksSeg2.map((week, index) => (<>
            <Text text={
                    String(activitySeg2[index]).substring(0, 30) + String(milestoneCategoryListSeg2[index]) + flagTrackerListSeg2[index]
                }
                x={
                    Seg2Values[index]["x"] + 3
                }
                y={
                    yBarListSeg2[index]
                }
                ...
                draggable={false}
                onClick={
                    e => this.setState({activityPlaceholder: activitySeg2[index], commentaryPlaceholder: commentarySeg2[index]})
                }/>
            <Line points={
                    [
                        Seg2Values[index]["x"],
        ...
        const Segment3Categories = weeksSeg3.map((week, index) => (<>
            <Text text={
                    activitySeg3[index] + + flagTrackerListSeg3[index]
                }
                x={
                    Seg3Values[index]["x"] + 3
                }
                y={
                    yBarListSeg3[index]
                }
                ...
                draggable={false}
                onClick={
                    () => this.setState({activityPlaceholder: activitySeg3[index], commentaryPlaceholder: commentarySeg3[index]})
                }/>
            <Line points={
                    [
                        Seg3Values[index]["x"],
        ...
        const Segment4Categories = weeksSeg4.map((week, index) => (<>
            <Text text={
                    activitySeg4[index] + + flagTrackerListSeg4[index]
                }
                x={
                    Seg4Values[index]["x"] + 3
                }
                y={
                    yBarListSeg4[index]
                }
                ...
                draggable={false}
                onClick={
                    () => this.setState({activityPlaceholder: activitySeg4[index], commentaryPlaceholder: commentarySeg4[index]})
                }/>
            <Line points={
                    [
                        Seg4Values[index]["x"],
        ...
        const Segment5Categories = weeksSeg5.map((week, index) => (<>
            <Text text={
                    activitySeg5[index] + + flagTrackerListSeg5[index]
                }
                x={
                    Seg5Values[index]["x"] + 3
                }
                y={
                    yBarListSeg5[index]
                }
        ...
        const Segment6Categories = weeksSeg6.map((week, index) => (<>
            <Text text={
                    activitySeg6[index] + flagTrackerListSeg6[index]
                }
                x={
                    Seg6Values[index]["x"] + 3
                }
                y={
                    yBarListSeg6[index]
                }
                ...
                draggable={false}
                onClick={
                    () => this.setState({activityPlaceholder: activitySeg6[index], commentaryPlaceholder: commentarySeg6[index]})
                }/>
            <Line points={
                    [
                        Seg6Values[index]["x"],
        ...
        const ElectricalEvents = elecrificationSeg1.map(electric => (<Text key={electric}
            text="⚡"
            fontSize={27}
            x={
                48 * electric - 18
        ...
        const handleClick = e => {
            this
                .scrollReference
                .current
                .scrollLeft = todayDateLocation - 250;
        };
        return (<>
                ...
                <div className="imageplaceholder"
                    ...
                    <svg height="100%" strokeMiterlimit="10" version="1.1" viewBox="0 0 300 700" width="100%" transform="translate(0,27.2)">
                        <g clipPath="Sidebar" id="Layer-1" fill="green">
                            ...
                            <rect x="268" y="319" width="30" height="6"
                                fill={Segment1Color}/>
                            <rect x="268" y="332" width="30" height="6"
                                fill={Segment2Color}/>
                            <rect x="268" y="344" width="30" height="6"
                                fill={Segment3Color}/>
                            <rect x="268" y="360" width="30" height="6"
                                fill={Segment4Color}/>
                            <rect x="268" y="372.1" width="30" height="6"
                                fill={Segment5Color}/>
                            <rect x="268" y="385.1" width="30" height="6"
                                fill={Segment6Color}/>
            ...
            <div className="block"
                ...
                <div className="relative"> {monthsArray}</div>
        ...
        <Layer> {Segment1Categories}
            {Segment2Categories}
            {Segment3Categories}
            {Segment4Categories}
            {Segment5Categories}
            {Segment6Categories}
            {ElectricalEvents} </Layer>
        <Layer>
            <Rect x={todayDateLocation}
                y={5}
                width={2}
                height={800}
                fill="green"></Rect>
            <Text x={todayDateLocation}
                y={35}
                text="Today"
                fontSize={15}
                fill="white"></Text>
...
<div style={
    ...
    <Text fill={textColor}>
        Activity:-{activityPlaceholder} </Text>
    <br></br>
    <Text fill={textColor}>
        Commentary:- {commentaryPlaceholder} </Text>
</div></>);
    }
}
